 ...
 * Not supported
 *
 * Default flash offsets for nucleo_u3c5zi_q:
 *
 * 0x000_0000 OTP / NV counters area (8 KB)
 * 0x000_2000 Protected Storage Area (8 KB)
 * 0x000_4000 Internal Trusted Storage Area (8 KB)
 * 0x000_6000 Secure primary image (256 KB)
 * 0x004_6000 Non-secure primary image (512 KB)
 * 0x00C_6000 Secure secondary image (256 KB)
 * 0x010_6000 Non-secure secondary image (512 KB)
 * 0x018_6000 Non-secure private storage (up to 488 KB)
 *
...
/* Same as FLASH0_SIZE */
#define FLASH_B_SIZE                    (0x100000)   /* 1024 KBytes*/
